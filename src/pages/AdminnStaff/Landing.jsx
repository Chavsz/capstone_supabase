      ...
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto space-y-4">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="px-7 py-2.5 bg-blue-600 text-white font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm hover:bg-blue-700 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
