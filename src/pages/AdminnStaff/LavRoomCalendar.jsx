...
const LavRoomCalendar = () => {
  ...
  return (
    <div className="min-h-screen p-4 md:p-6">
      ...
      <div className="bg-[#e9f2ff] rounded-3xl border border-[#d4e2ff] p-3 shadow-sm">
        ...
        <div className="lg:hidden border border-[#1433a5] bg-[#e9f2ff] rounded-2xl p-2">
        ...
        <div
          ref={gridRef}
          className="relative border border-[#1433a5] bg-[#e9f2ff] overflow-visible hidden lg:grid grid-cols-5"
        >
