...
const MyClasses = () => {
  ...
  const bookingsByDay = useMemo(() => {
    ...
    filteredAppointments.forEach((appointment) => {
      ...
      if (dateValue < weekStartDate || dateValue > weekEndDate) return;
      const dayIndex = dateValue.getDay() === 0 ? -1 : dateValue.getDay() - 1;
  ...
  const matchingDayIndices = useMemo(() => new Set(), []);
  const desktopMatchingDayIndices = useMemo(() => new Set(), []);
