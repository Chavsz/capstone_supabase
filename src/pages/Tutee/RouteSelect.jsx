...
const RouteSelect = ({ onClose }) => {
  ...
  return (
    <div className="space-y-1">
      ...
      />
      <Route
        to="/dashboard/my-learning-journey"
        Icon={mdIcons.MdTimeline}
        title="My Learning Journey"
        isActive={location.pathname === "/dashboard/my-learning-journey"}
        onClose={onClose}
      />
      <Route
...
const Route = ({ to, Icon, title, isActive, onClose }) => {
  return (
    <NavLink
      to={to}
      className={`flex items-center justify-start gap-2 w-full rounded px-2 py-2 md:py-1.5 md:text-sm text-1xl transition-all duration-300 ${
        isActive
